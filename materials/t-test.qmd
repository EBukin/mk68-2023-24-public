...
-   we compare $t$ to a **critical value** $c_{df, \text{CL}}$, with
...
-   is the **minimum values of the t-statistics** when we **can reject** $H_0$ 
    ...
    -   at the given **level of significance**, and
    
    -   with the given **number of degrees of freedom**.

FYI: Significance level depends on the alternative hypothesis:
...
-   the absolute value of the t-statistics is striclty greater then the critical value.
