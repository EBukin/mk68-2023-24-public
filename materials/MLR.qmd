...
We use data on motor fuel consumption and related variables, for the year 2001. Each observation represents a state in the United States. (based on the data from @weisberg2013applied). Variables are:
