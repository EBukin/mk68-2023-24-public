...
::: fragment
1/2   We conclude **to accept** $H_0$: stunting rate did not change after training.
:::

::: fragment
2/2   Training helped but, e.g., the food shortage deepened the malnutrition problem in the survey year.
:::
...
1.    Describe how you would measure the outcome variable.

2.    Formulate $H_0$ and $H_1$.

3.    Discuss Type I and Type II errors in the context of your hypothesis.

4.    Provide examples of factors that could lead to these errors.

5.    Propose an RCT experiment that could help answer these questions.

6.    Explain what makes an RCT a good/bad solution to the research question.    
:::
...
-   Are wheat yields higher on farms that use precision agriculture?
...
<https://journals.plos.org/plosone/article/figure/image?size=large&id=10.1371/journal.pone.0175216.g003>
