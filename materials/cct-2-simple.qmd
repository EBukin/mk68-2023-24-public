...
2.  Two sample t-test (not covered):
...
For example, in Turkey, Ahmed et al. (2007) failed to show that CCTs improve/worsen children's school enrollment. With "H0: no improvement" versus the "H1: some improvement", the authors failed to reject the H0 at the 5% sign. level for populations of primary and secondary school attendees ...
:::
:::
