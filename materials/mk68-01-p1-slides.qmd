---
title: "Week 01 part 1. Introduction: Population and Sample. Description and Inference."
editor: source
format: revealjs
editor_options: 
...
3.  How does access to education impact income inequality?

4.  What are the factors influencing malnutrition rates among children in a specific region?

5.  How does access to clean water and sanitation facilities impact child mortality rates?

6.  What are the barriers to accessing healthcare services among marginalized communities?

-   **How to answer such research questions?**
...
-   What is **"the correct"** average yields?
    ...
    -   What is the population average of the wheat yields?
...
This property is based on the **Law of Large Numbers** (LLN)
...
# Common examples of populaiton and samples

1.  What is the average poverty headcount rate in the world/a country?

    -   Population: people or households;
    
    -   Sample examples: household surveys. For example:
        
        -   The Living Standards Measurement Study (LSMS) <https://www.worldbank.org/en/programs/lsms>
...
-   Random sample are different: result with different estimates.

    -   Thus, descriptive statistics derived from each sample is not identical to the population.
...
# Example of statistical inference in a research
