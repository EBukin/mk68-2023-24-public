...
Column (1) reports the mean in returns and yields between control and treatment fields for different rates of fertilizer application over all growing seasons.

:::
::: {.column width="50%"}
-   What yields change is associated with different levels of fertilizers application?

-   Can we conclude that fertilizers application improves yields/returns on average in the population?

-   What rates of fertilizers application improve yields/returns on average in the population?
:::
:::
...
-   specifically with respect to the monetary return levels.
...
-   monetary outcomes often depend on many observed and unobserved factors, therefore, they are often seen as "endogenous" in econometrics.
    ...
    -   What other factors can have an effect on the return?
    
    -   How can we ensure that other factors have no effect on the return?
...
If other factors have no effect on return,

-   What signs/values coefficients $\beta_\cdot$ should have?

-   Formulate ex-ante hypothesis about the expected signs of the coefficients.

## Checks and balance (1)
...
Dependent variables: Return %.
:::

::: {.column width="25%"}

-   What effect education or other factors have on the return?
